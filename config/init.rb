...
require 'find'
require 'net/http'
# Load activesupport *here* to get the to_xml method --
# after this Merb will load json/ext and override
# activesupport's crappy to_json method with its own
...
Merb::Config.use do |c|
  ...
  c[:session_secret_key]  = 'XXXXXXXXX'
...
begin
  require File.join(File.dirname(__FILE__), '..', 'lib',
    'authenticated_system/authenticated_dependencies')
rescue LoadError
end
